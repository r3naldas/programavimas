                ...
                <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
                    <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                        <div class="d-table m-auto">
                            <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;" src="{{asset('HTML/images/shards-dashboards-logo.svg')}}" alt="Shards Dashboard">
...
<script src="{{asset('HTML/scripts/app/app-blog-overview.1.1.0.js')}}"></script>
</body>
</html>
